...
#Find city budget
district_budget <- ~Total.Budget
#Find average math/read scores of all students 
avg_math_score <- ~Avg.Math
avg_read_score <- ~Avg.Reading
#Find passing percentage
math_pass_rate <- ~Percent.Passing.Math
read_pass_rate <- ~Percent.Passing.Reading
ovrll_pass_rate <- ~Overall.Passing
